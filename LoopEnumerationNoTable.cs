...
namespace CrawfisSoftware.PCG
{
    ...
    /// </summary>
    public class LoopEnumerationNoTable
    {
        ...
        public LoopEnumerationNoTable(int width, int height, Random random, Validator verticalCandidateOracle = null,
        ...
        public IEnumerable<(IList<int> vertical, IList<int> horizontal)> Enumerate()
        {
            ...
            foreach (var grid in EnumerateRecursive( 0, verticalPaths, horizontalPaths, components))
            {
                yield return grid;
            }
        }
            ...
            if (index == 0)
            {
                ...
                foreach (int outflow in _evenTable)
                {
                               ...
                               out horizontalSpans))
                    {
                        ...
                        foreach (var newGrid in EnumerateRecursive(index + 1, verticalPaths, horizontalPaths, components))
                        {
