...
namespace CrawfisSoftware.PCG
{
    ...
    /// </summary>
    public class PathSamplerBottomToTopCarryOverBit
    {
        private const int MaxDefaultAttempts = 100;
        ...
        public PathSamplerBottomToTopCarryOverBit(int width, int height, Random random,
        ...
        public (IList<int> vertical, IList<int> horizontal)
            Sample(int start, int end, int numColumns = 2)
        {
